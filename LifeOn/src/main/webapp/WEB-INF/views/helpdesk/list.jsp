	...
	<main class="d-flex flex-column min-vh-100 align-items-center"
		...
		<div class="container">
			<div class="body-container">
				...
				<div class="body-main">
					<div class="category">
						<button class="btn active" id="faqBtn" onclick="showSection('faq')">자주묻는질문</button>
						<button class="btn" id="chatBtn" onclick="showSection('chat')">1:1채팅상담</button>
					</div>
						...
						<div class="table-border">
							<table class="table">
								<thead>
									...
									<tr>
										<td class="answer">A: 네, 비회원으로도 구매가 가능합니다. 하지만 회원 가입 시
											다양한 혜택을 누릴 수 있습니다.</td>
									</tr>
					...
					<div id="chatSection" style="disply:none;">
						<p>채팅 상담 페이지입니다. 상담 시작하려면 상담버튼 눌러주세요</p>
					</div>
