...
<c:if test="${sessionScope.member.userId==dto.userId||sessionScopse.member.userLevel > 50 }">
...
$(function() {
	$('.btnSendBoardLike').click(function(){
		...
		let msg = userLiked ? '게시글 공감을 취소하시겠습니까? ' : '게시글을 공감하시겠습니까?';
